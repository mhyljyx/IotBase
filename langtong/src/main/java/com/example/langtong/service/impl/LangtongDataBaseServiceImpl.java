package com.example.langtong.service.impl;

import cn.hutool.core.util.ObjectUtil;
import com.example.langtong.config.DataSourceConfig;
  ...
  public List<LangTongAccessInfoParams> readLangTongAccessInfo(Date dateTime) {
    ...
    try {
      ...
      while (resultSet.next()) {
        ...
        accessInfo.setPassTime(DateUtil.transTimeToUTCDate(resultSet.getString("datetime")));
